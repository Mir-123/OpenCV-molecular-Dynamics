...
//
  ...
  {
    printf ( "\n" );
    printf ( "  Enter NP, the number of particles (1000, for instance).\n" );
    scanf ( "%d", &np );
  }
//
...
//
  ...
  {
    printf ( "\n" );
    printf ( "  Enter ND, the number of time steps (400, for instance).\n" );
    scanf ( "%d", &step_num );
  }
//
//  Get the time steps.
//
  ...
  {
    printf ( "\n" );
    printf ( "  Enter DT, the size of the time step (0.000100, for instance).\n" );
    scanf ( "%lf", &dt );
  }
